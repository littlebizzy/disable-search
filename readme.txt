...
Donate link:
Tags: disable, search, form, query, database, uncached, dynamic, SEO, security
...
Completely disables the built-in WordPress search function to prevent snoopers or bots from querying your database and/or slowing down your site.
...
1. Upload the plugin files to `/wp-content/plugins/disable-search-littlebizzy`
2. Activate the plugin through the 'Plugins' screen in WordPress
3. Test that search queries are "404" by appending '/?s=foo` to your site URL
...
= 1.0 =
* Initial released based on private research and comparing other free plugins.
